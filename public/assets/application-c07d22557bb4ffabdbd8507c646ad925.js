...
(function() {
  $(function() {
    var add_count;
    add_count = 0;
    return $("td.add_blog_link").click(function() {
      add_count += 1;
      return $("table.table").append("<tr>        <td><input type='text' name='blog_link[new][" + add_count + "][title]'></td>        <td><input type='text' name='blog_link[new][" + add_count + "][url]'></td>      </tr>");
    });
  });
...
(function() {
  $(function() {
    var add_count;
    add_count = 0;
    return $("td.add_user").click(function() {
      add_count += 1;
      return $("table.table").append("<tr>        <td><input type='text' name='user[new][" + add_count + "][screen_name]'></td>        <td><input type='text' name='user[new][" + add_count + "][provider]'></td>      </tr>");
    });
  });
...
(function() {
  $(function() {
    var add_count;
    add_count = 0;
    return $("td.add_version").click(function() {
      add_count += 1;
      return $("table.table").append("<tr>      <td><input type='radio' name='version[current]' value='new_" + add_count + "'></td>      <td><input type='text' name='version[new][" + add_count + "]'></td>      </tr>");
    });
  });
