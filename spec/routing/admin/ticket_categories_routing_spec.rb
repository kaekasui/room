...
describe Admin::TicketCategoriesController do
  describe "routing" do
    ...
    it "routes to #new." do
      expect(get "admin/ticket_categories/new").to route_to("admin/ticket_categories#new")
    end

    it "routes to #create." do
      expect(post "admin/ticket_categories").to route_to("admin/ticket_categories#create")
    end
