...
=begin
  ...
  describe "GET index" do
    it "assigns all trackers as @trackers" do
      ...
      assigns(:trackers).should eq([tracker])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new tracker as @tracker" do
      ...
      assigns(:tracker).should be_a_new(Tracker)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created tracker as @tracker" do
        post :create, {:tracker => valid_attributes}, valid_session
        assigns(:tracker).should be_a(Tracker)
        assigns(:tracker).should be_persisted
      end

      it "redirects to the created tracker" do
        post :create, {:tracker => valid_attributes}, valid_session
        response.should redirect_to(Tracker.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved tracker as @tracker" do
        ...
        Tracker.any_instance.stub(:save).and_return(false)
        post :create, {:tracker => { "name" => "invalid value" }}, valid_session
        assigns(:tracker).should be_a_new(Tracker)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested tracker" do
        tracker = Tracker.create! valid_attributes
        # Assuming there are no other trackers in the database, this
        # specifies that the Tracker created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Tracker.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => tracker.to_param, :tracker => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the tracker as @tracker" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Tracker.any_instance.stub(:save).and_return(false)
        put :update, {:id => tracker.to_param, :tracker => { "name" => "invalid value" }}, valid_session
        assigns(:tracker).should eq(tracker)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the trackers list" do
      tracker = Tracker.create! valid_attributes
      delete :destroy, {:id => tracker.to_param}, valid_session
      response.should redirect_to(trackers_url)
    end
  end
=end
end
