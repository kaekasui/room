  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved function as @function" do
        ...
        post :create, {:function => { "name" => "invalid value" }}, valid_session
        assigns(:function).should be_a_new(Function)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested function" do
        ...
        Function.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => function.to_param, :function => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the function as @function" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Function.any_instance.stub(:save).and_return(false)
        put :update, {:id => function.to_param, :function => { "name" => "invalid value" }}, valid_session
        assigns(:function).should eq(function)
      end
